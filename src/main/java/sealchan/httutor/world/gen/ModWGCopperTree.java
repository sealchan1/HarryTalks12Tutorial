...
public class ModWGCopperTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.LOG_COPPER.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_COPPER.getDefaultState();
	
	private final int minHeight;
	
	public ModWGCopperTree() 
	{
		super(false);
		this.minHeight = 12;
	}
	...
	protected boolean canGrowInto(Block blockType)
	{
		...
		return material == Material.AIR 
				...
				//|| blockType == BlockInit.COPPER_DIRT
